 ...
 */
final class Version20241104071155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE approvals (id SERIAL NOT NULL, changed_by_id INT DEFAULT NULL, post_id INT NOT NULL, approved_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, changed_to VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE post_categories (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE posts (id SERIAL NOT NULL, author_id INT NOT NULL, post_type_id INT NOT NULL, post_category_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT DEFAULT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
